...
int prevPA0; //holds previous value of PA0 for falling/rising edge purposes
//******************************************************************************
//Main Function
void main() {
//Initializations
     ...
     while(1){
//Objective 2
          GPIOE_ODR = num1;   //PE13 and PE15 need to be high in order for the 7-segments to display a number. PE11 switch which
